        ...
        <table>
                    ...
                    <table style="background:#FFCC99; border-radius:20px">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                            	<input type="submit" name="btnSignIn" id="btnSignIn" value="SignIn" />
			...
			<?php
					...
					if(isset($_POST["btnSignIn"]))
					{
						...
						{
							$_SESSION["admin"]=$_POST["txtUserName"];
							echo "<script>window.top.location='welcomeAdmin.php'</script>";exit;
