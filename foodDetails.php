    ...
    <div id="tooplate_wrapper">
        ...
        <table>
		  ...
		  <td align="center" colspan="2">
			<?php
				if(isset($_SESSION['BMI_RES']))
				{
				}
				else
				{
					header('location:calcultion.php');
				}
				$qry="select sid,bmi,day,breakfast,lunch,snacks,dinner from scale where bmi='".$_SESSION['BMI_RES']."' order by sid asc";
